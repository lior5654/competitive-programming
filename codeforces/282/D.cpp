...
bool vis[4][301][301][301] = { { { 0 } } };
bool dp2[301][301] = { { 0 } };
bool vis2[3][301][301] = { { 0 } };
...
void solve()
{
    ...
    for(int i = 0; i <= 300; ++i)
    {
        for(int j = 0; j <= 300; ++j)
        {
            for(int k = 0; k <= 300; ++k)
            {
                ...
                for(int o = 1; i + o <= 300 && !vis[0][i+o][j][k]; ++o)
                {
                    dp[i+o][j][k] = true;
                    vis[0][i+o][j][k] = true;
                }
                for(int o = 1; j + o <= 300 && !vis[1][i][j+o][k]; ++o)
                {
                    dp[i][j+o][k] = true;
                    vis[1][i][j+o][k] = true;
                }
                for(int o = 1; k + o <= 300 && !vis[2][i][j][k+o]; ++o)
                {
                    dp[i][j][k+o] = true;
                    vis[2][i][j][k+o] = true;
                }
                int mx = max({i, j, k});
                for(int o = 1; mx + o <= 300 && !vis[3][i+o][j+o][k+o]; ++o)
                {
                    dp[i+o][j+o][k+o] = true;
                    vis[3][i+o][j+o][k+o] = true;
                }
            }
        }
    }
    ...
    for(int j = 0; j <= 300; ++j)
    {
        ...
        {
            if(dp2[j][k]) continue;
            for(int o = 1; j + o <= 300 && !vis2[0][j+o][k]; ++o)
            {
                dp2[j+o][k] = true;
                dp2[k][j+o] = true;
                vis2[0][j+o][k] = true;
            }
            for(int o = 1; k + o <= 300 && !vis2[1][j][k+o]; ++o)
            {
                dp2[j][k+o] = true;
                dp2[k+o][j] = true;
                vis2[1][j][k+o] = true;
            ...
            int mx = max(j, k);
            for(int o = 1; mx + o <= 300 && !vis2[2][j+o][k+o]; ++o)
            {
                dp2[j+o][k+o] = true;
                dp2[k+o][j+o] = true;
                vis2[2][j+o][k+o] = true;
    ...
    if(n==1)
    {
        cout << (ar[0]?FIRST:SECOND) << endl;
    }
    else if (n==2)
    {
        cout << (dp2[ar[1]][ar[0]]?FIRST:SECOND) << endl;
    }
    else
    {
